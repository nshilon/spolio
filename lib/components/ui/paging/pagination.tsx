    ...
    >
      ...
      >
        <Icon
          name="arrow-first"
          size="small"
          className={`[stroke-width:${strokeWidth(!!hasPrevious)}]`}
        />
      </Button>
      ...
      <Typography className="mb-0" aria-label="Page">
      ...
      >
        <Icon
          name="arrow-right"
          size="small"
          className={`[stroke-width:${strokeWidth(!!hasNext)}]`}
        />
      </Button>
